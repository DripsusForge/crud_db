...
// Configuración de conexión flexible (Render usa DATABASE_URL, local usa las variables separadas)
const pool = process.env.DATABASE_URL 
    ...
    : new Pool({
        ...
        password: String(process.env.DB_PASSWORD), // Forzamos que sea un string para evitar el error SASL
